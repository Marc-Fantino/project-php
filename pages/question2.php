...
$question = array(
                ...
                array(
                    "Questionone1" =>"Comment faire appel une class dans un fichier CSS ?",
                    "reponse1" => "#class",
                    "reponse2" => ".class",
                    "reponse3" => ".google.fr comment on appel une class dans le css",
                    "reponse4" => "je me suis pas posé la question j'aime le style 'Wilkipédia' ",
                    "reponse5" => "class"
                ),
);
?>
...
?>
    ...
    <div class="text-center container container-sm p-3 my-2 border bg-primary text-white w-50">
             <h2 class="text-sucess"><?= $tableau['Questionone1'] ?></h2>
        </div>
...
if(isset($_POST['validerReponse'])){
    ...
    if($reponseOk ===$tableau['reponse2']){
        ...
        echo "<p class='mt-2 alerte alerte-success p-3'>Bien joué la réponse etait = " . $tableau['reponse2'] . "</p>";
        echo "<p class='mt-2 alerte alerte-success p-3'>Votre score est de = " . $_SESSION['score'] . "</p>";
        ?>
        <!--On affiche un lien pour continuer le jeu-->
        <a href="question3.php" class="btn btn-success bg-success">Passer à la question suivante</a>
        <style>
        #btn-ok{
        display: none;}
        #question{
        ...
        echo "<p class='mt-2 alerte alerte-warning p-3'>Et non la réponse etait = " . $tableau['reponse2'] . "</p>";
        echo "<p class='mt-2 alerte alerte-success p-3'>Votre score est de = " . $_SESSION['score'] . "</p>";
        ?>
           <style>
        #btn-ok{
        ...
        display: none;}
         ...
         <a href="question3.php" class="btn btn-sucess bg-danger">Passer à la question suivante</a>
        <?php
    }
