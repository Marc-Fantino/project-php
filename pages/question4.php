...
$question = array(
                ...
                array(
                    "Questionone4" =>"comment appeler du php dans une Div HTML ?",
                    "reponse1" => "&lt;!= !&gt;",
                    "reponse2" => "&lt;?= ?&gt;",
                    "reponse3" => "&lt;?_ ?&gt;",
                    "reponse4" => "&lt;$= $&gt;",
                    "reponse5" => "Demande à ton voisin"
                ),
);
?>
...
?>
    ...
    <div class="text-center container container-sm p-3 my-2 border bg-primary text-white w-50">
             <h2 class="text-sucess"><?= $tableau['Questionone4'] ?></h2>
...
if(isset($_POST['validerReponse'])){
    ...
    if($reponseOk ===$tableau['reponse2']){
        ...
        <a href="question5.php" class="btn btn-success bg-success">Passer à la question suivante</a>
        <style>
        #btn-ok{
        display: none;}
        #question{
        ...
        echo "<p class='mt-2 alerte alerte-success p-3'>Votre score est de = " . $_SESSION['score'] . "</p>";
        ?>
         <a href="question5.php" class="btn btn-sucess bg-danger">Passer à la question suivante</a>
         <style>
        #btn-ok{
        display: none;}
        #question{
