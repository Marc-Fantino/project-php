...
<div class="container-fluid" id="questionnaire">
    ...
    <h1 class="text-info text-center">Bienvenue : <?= $_SESSION['pseudo']; ?></h1>
...
?>
    ...
    <!--Afficher la question-->
        ...
        <button type="submit" name="validerReponse" id="btn-ok" class="mt-2 btn btn-warning ms-5">Valider votre réponse</button>
        </div>
...
if(isset($_POST['validerReponse'])){
    ...
    if($reponseOk == $tableau['reponse2']){
        ...
        echo "<p class='mt-2 alerte alerte-success text-center p-3'>Bien joué la réponse etait = " . $tableau['reponse2'] . "</p>";
        ...
        <a href="question2.php" class="btn btn-success bg-success text-center p-3">Passer à la question suivante</a>
        <?php
    }else{
        //si la réponse n'est pas correct
        $_SESSION['score'] += 0;
        // on affiche la bonne réponse et le message d'erreur
        echo "<p class='mt-2 alerte alerte-warning text-center p-3'>Et non la réponse etait = " . $tableau['reponse2'] . "</p>";
        
        ?>
        
         <a href="question2.php" class="btn btn-sucess bg-danger text-center p-3">Passer à la question suivante</a>
         <style>
        #btn-ok{
        display: none;}
        #question{
